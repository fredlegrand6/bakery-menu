      ...
      >
        ...
        <motion.div
          ...
          className={cn(
            ...
            isOpen ? 'bg-terracotta text-cream' : 'bg-white/5 text-sage/40'
          )}
        >
          <ChevronDown size={16} />
        </motion.div>
          ...
          return (
            <div key={section.id}>
              <div className="px-0 pt-8 pb-1">
                <h2 className="font-display text-2xl font-bold text-cream">{section.name}</h2>
                <div className="w-10 h-0.5 bg-terracotta mt-2 mb-1" />
              </div>
