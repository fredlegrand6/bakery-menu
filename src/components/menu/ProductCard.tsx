  ...
  return (
    <>
      <motion.article
        ...
        className="group relative rounded-[22px] overflow-hidden glass cursor-pointer"
      ...
      >
        ...
        {/* media */}
        <div
          className="relative aspect-[16/10] overflow-hidden transition-transform duration-500 ease-out group-hover:scale-[1.03]"
