...
export default function AttributesTab() {
  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div key="attributes" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="px-4 md:px-12 lg:px-16 py-4 md:py-10 pb-40 md:pb-10 space-y-3 md:space-y-14">
